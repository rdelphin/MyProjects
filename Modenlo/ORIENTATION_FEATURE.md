...
## Overview
The Modenlo app now includes a comprehensive orientation feature that allows users to select between portrait and landscape frame orientations. The app intelligently auto-detects the best orientation based on the uploaded photo's aspect ratio.
